...
//           <button
//             onClick={() => setOpen(false)}
//             className={'flex items-center text-sm gap-2  h-[40px]'}
//           >
//             Cerrar{' '}
//             <svg
//               width="14"
...
//           </button>
//         </div>
//         <ul className={'flex flex-col gap-2 pb-4 items-end border-b px-4'}>
//           {menu[0].map((item) => {
//             return (
//               <li>
...
//           })}
//         </ul>
//         <ul className={'flex flex-col gap-2 py-4 items-end border-b px-4'}>
//           {menu[1].map((item) => {
//             return (
//               <li>
//                 <a href={item.link}>{item.name}</a>
...
//           })}
//         </ul>
//         <ul className={'flex flex-col gap-2 py-4 items-end px-4 '}>
//           {menu[2].map((item) => {
//             return (
//               <li>
//                 <a href={item.link}>{item.name}</a>
